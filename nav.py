...
THEORY = {
    ...
    "sec2": ["xai_interp", "xai_black", "xai_tab", "xai_recourse", "xai_cv", "xai_vlm"],
    "sec3": ["fair_intro", "fair_metrics", "fair_llm", "fair_mitig", "fair_fap", "fair_align"],
    "sec4": ["rob_intro", "rob_formulation", "rob_attacks", "rob_defense", "rob_certified", "rob_llm"],
    "sec5": ["prv_poison", "prv_privacy", "prv_dp", "prv_noise", "prv_fl", "prv_leak"],
    "sec6": ["aln_gap", "aln_rlhf", "aln_dpo", "aln_variants", "aln_owasp", "aln_agency"],
}
